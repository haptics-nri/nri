...
public:
    ...
    /// \brief An enumerated integer property. Selects the operation. Write: mvSPIAccessLength bytes are written to SPI device. Synchronuously read bytes are stored to internal buffer. Read: Reads mvSPIAccessLength from internal buffer. If mvSPIAccessLength > internal buffer size: Additional 'write zeros' will be done.
    /**
...
public:
    ...
    /// \brief An integer property. The IP address of the action command recepient
    /**
...
public:
    ...
    /// \brief An integer property. Indicates the mode the internal resend algorithm is working in.
    /**
