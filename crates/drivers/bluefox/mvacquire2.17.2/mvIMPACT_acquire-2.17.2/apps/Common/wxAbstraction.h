...
//-----------------------------------------------------------------------------
{
    ...
    void Create( const wxBitmap& bmp )
    {
...
public:
    explicit SplashScreenScope() : pSplash_( 0 )
    {
        wxBitmap bmp( pSplashScreen_xpm );
        Create( bmp );
    }
    explicit SplashScreenScope( const wxBitmap& bmp ) : pSplash_( 0 )
    {
        Create( bmp );
    }
