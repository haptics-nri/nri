...
//-----------------------------------------------------------------------------
{
    ...
    */
    ...
    pSCDriveLevel_ = new wxSpinCtrlDouble();
    pSCDriveLevel_->Create( pPanel, widSCDriveLevel, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, driveLevelValue_Min, driveLevelValue_Max, driveLevelValue, 1. );
    pSCDriveLevel_->SetDigits( 1 );
