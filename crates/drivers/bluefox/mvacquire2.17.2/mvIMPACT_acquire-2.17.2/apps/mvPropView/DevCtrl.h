...
{
public:
    DevicePropertyHandler( wxPropertyGridPage* pPGDriver, wxPropertyGridPage* pPGDevice, bool boDisplayDebugInfo, bool boDisplayFullTree, bool boDisplayInvisibleComponents );
...
private:
    ...
    wxPropertyGridPage*                         m_pPGDriver;
