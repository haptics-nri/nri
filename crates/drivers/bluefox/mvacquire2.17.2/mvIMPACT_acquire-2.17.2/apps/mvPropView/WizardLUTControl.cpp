...
//-----------------------------------------------------------------------------
{
    ...
    */
    ...
    pSCGamma_ = new wxSpinCtrlDouble();
    pSCGamma_->Create( pPanel, widSCGamma, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0.01, 10., data.gamma_, 0.01 );
    pSCGamma_->SetDigits( 2 );
    pGridSizer->Add( pSCGamma_, wxSizerFlags().Expand() );

    pGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( " Gamma Alpha:" ) ) );
    pSCGammaAlpha_ = new wxSpinCtrlDouble();
    pSCGammaAlpha_->Create( pPanel, widSCGammaAlpha, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0.0, 1., data.gammaAlpha_, 0.001 );
    pSCGammaAlpha_->SetDigits( 3 );
