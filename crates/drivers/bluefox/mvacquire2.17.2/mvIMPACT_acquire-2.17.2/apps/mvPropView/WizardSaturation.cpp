...
//-----------------------------------------------------------------------------
{
    ...
    */
    ...
    pSCSaturation_->Create( pSaturationSizer->GetStaticBox(), widSCSaturation, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, -10., 10., 1., 0.001 );
    pSCSaturation_->SetDigits( 3 );
