      ...
      //-----------------------------------------------------------------------------
{
    ...
    pColorFlexGridSizer->Add( pBtnPresetColor_, wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pColorFlexGridSizer->AddSpacer( 10 );
    pColorFlexGridSizer->AddSpacer( 10 );
    pColorFlexGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( " Color" ) ), wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pColorFlexGridSizer->AddSpacer( 10 );

    wxFlexGridSizer* pGrayscaleFlexGridSizer = new wxFlexGridSizer( 3 );
    pGrayscaleFlexGridSizer->AddSpacer( 10 );
    pGrayscaleFlexGridSizer->Add( pBtnPresetGray_, wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pGrayscaleFlexGridSizer->AddSpacer( 10 );
    pGrayscaleFlexGridSizer->AddSpacer( 10 );
    pGrayscaleFlexGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( " Grayscale" ) ), wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pGrayscaleFlexGridSizer->AddSpacer( 10 );
    ...
    pSliderFlexGridSizer->AddSpacer( 1 );
    pSliderFlexGridSizer->AddSpacer( 1 );
    pSliderFlexGridSizer->Add( pStaticBitmapQuality_, wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pSliderFlexGridSizer->Add( pSliderDisplacementSizer );
    pSliderFlexGridSizer->Add( pStaticBitmapSpeed_, wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pSliderFlexGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( "Best Quality" ) ), wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pSliderFlexGridSizer->AddSpacer( 10 );
    pSliderFlexGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( "Highest Speed" ) ), wxSizerFlags().Center().Align( wxALIGN_CENTER ) );

    wxFlexGridSizer* pFactoryFlexGridSizer = new wxFlexGridSizer( 3 );
    pFactoryFlexGridSizer->AddSpacer( 10 );
    pFactoryFlexGridSizer->Add( pBtnPresetFactory_, wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pFactoryFlexGridSizer->AddSpacer( 10 );
    pFactoryFlexGridSizer->AddSpacer( 10 );
    pFactoryFlexGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( " Factory" ) ), wxSizerFlags().Center().Align( wxALIGN_CENTER ) );
    pFactoryFlexGridSizer->AddSpacer( 10 );
    ...
    pSCExposure_ = new wxSpinCtrlDouble();
    pSCExposure_->Create( pPanel, widSCExposure, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, -10., 10., 1., 100 );
    pSCExposure_->SetDigits( 0 );
    ...
    pSCGain_ = new wxSpinCtrlDouble();
    pSCGain_->Create( pPanel, widSCGain, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, -10., 10., 1., 0.001 );
    pSCGain_->SetDigits( 3 );
    ...
    pSCBlackLevel_ = new wxSpinCtrlDouble();
    pSCBlackLevel_->Create( pPanel, widSCBlackLevel, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, -10., 10., 1., 0.001 );
    pSCBlackLevel_->SetDigits( 3 );
    ...
    pSCSaturation_ = new wxSpinCtrlDouble();
    pSCSaturation_->Create( pPanel, widSCSaturation, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, 1., 200., 100., 0.01 );
    pSCSaturation_->SetDigits( 2 );
    ...
    pSCWhiteBalanceR_ = new wxSpinCtrlDouble();
    pSCWhiteBalanceR_->Create( pPanel, widSCWhiteBalanceR, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, 1., 500., 100., 0.01 );
    pSCWhiteBalanceR_->SetDigits( 2 );
    ...
    pSCWhiteBalanceB_ = new wxSpinCtrlDouble();
    pSCWhiteBalanceB_->Create( pPanel, widSCWhiteBalanceB, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, 1., 500., 100., 0.01 );
    pSCWhiteBalanceB_->SetDigits( 2 );
    ...
    pSCFrameRate_ = new wxSpinCtrlDouble();
    pSCFrameRate_->Create( pPanel, widSCFrameRate, wxEmptyString, wxDefaultPosition, wxSize( 80, -1 ), wxSP_ARROW_KEYS, -10., 10., 1., 0.001 );
    pSCFrameRate_->SetDigits( 3 );
...
//-----------------------------------------------------------------------------
{
    ...
    return std::string( propertyPath.mb_str() ).substr( prefixToRemove.Length() ) + prop.name();
}
