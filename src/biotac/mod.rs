    ...
    guilty! {
        impl Controllable for Biotac {
            ...
            fn setup(_: Sender<CmdFrom>, _: Option<String>) -> Biotac {
                ...
                Biotac { cheetah: cheetah, info: info, finger: finger }
            }

            fn step(&mut self, _: Option<String>) {
                const PARITY: [u8; 128] = [0x01, 0x02, 0x04, 0x07, 0x08, 0x0B, 0x0D, 0x0E,
                ...
                unsafe {
                    ...
                    println!("spi_data_len = {}", spi_data_len);
                    ...
                    for i in 0..n_samples {
                        ...
                        for j in 0..3 {
                            ...
                            if (PARITY[(low >> 1) as usize] == low) && (PARITY[(high >> 1) as usize] == high) {
                                match channel_id {
                                    3 => println!("TDC = {}", spi_data),
                                    2 => println!("TAC = {}", spi_data),
                                    1 => println!("PDC = {}", spi_data),
                                    0 => println!("PAC #{} = {}", pac_index, spi_data),
                                    c @ 17...35 => println!("Electrode #{} = {}", c - 17, spi_data),
                                    _ => println!("bad channel ID"),
                                }
